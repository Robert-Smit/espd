...
<form:form id="espdform" role="form" class="form-horizontal" method="post" commandName="espd">
    ...
    <div class="panel panel-espd">
        <div data-i18n="createcafinish_export" class="panel-heading" data-toggle="collapse" data-target="#finish-statements-section">
        ...
        <div id="finish-statements-section" class="collapse in">
            <div class="espd-panel-body panel-body">
                <c:if test = "${agent == 'ca'}">
                    <span>
                        <s:message code='createcafinish_export_content_tn_ca'/>
                    </span>
                </c:if>
                <c:if test = "${agent == 'eo'}">
                    <c:choose>
                        <c:when test="${tenderned.inschrijffase == 'true'}">
                            <span>
                        ...
                        <c:otherwise>
                            <span>
                                <s:message code='createeofinish_export_content_tn_aanmelding'/>
                            </span>
                        </c:otherwise>
                    </c:choose>
